...
class ImageProcessor:
    ...
    def image_scan(self):
        imgz=cv2.imread("darts_picture.jpg")
        ...
        #cv2.resizeWindow("img", 310, 330)

        # frameに画像を入れて切り抜き
        img2 = imgz[230:323, 310:391]
        #img2 = imgz[350:500, 600:700]

        # 画像の平滑化
        img_bi = cv2.bilateralFilter(img2, 9, 120, 120)
        ...
        self.photonumber += 1
        print("photoorder="+str(self.photoorder))
        print("flag="+str(flag))

        cv2.imshow("img",color_src01)
        cv2.waitKey(0)
        cv2.destroyAllWindows()
        cv2.imwrite("darts_image1.jpg",img2)



imageprof=ImageProcessor()
imageprof.image_scan()
